...
namespace SasonBase.Reports.Sason.Merkez
{
    ...
    /// </summary>
    public class MrkzYdkPrcFlytRprListe2 : Base.SasonMerkezReporter 
    {
        public MrkzYdkPrcFlytRprListe2()
        {
            Text = "Yedek Parça Faliyet Raporu (Liste)";
            SubjectCode = "MrkzYdkPrcFlytRprListe2";
        ...
        public MrkzYdkPrcFlytRprListe2 (decimal servisId, DateTime startDate, DateTime finishDate) : this()
        {
