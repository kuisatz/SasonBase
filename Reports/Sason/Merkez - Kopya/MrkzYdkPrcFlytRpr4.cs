...
namespace SasonBase.Reports.Sason.Merkez
{
    ...
    /// </summary>
    public class MrkzYdkPrcFlytRpr4 : Base.SasonMerkezReporter
    {
        public MrkzYdkPrcFlytRpr4()
        {
            Text = "Yedek Parça Faaliyet Raporu";
            SubjectCode = "MrkzYdkPrcFlytRpr4";
        ...
        public MrkzYdkPrcFlytRpr4(decimal servisId, DateTime startDate, DateTime finishDate) : this()
        {
