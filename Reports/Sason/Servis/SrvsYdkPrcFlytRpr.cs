...
namespace SasonBase.Reports.Sason.Servis
{
    ...
    /// </summary>
    public class SrvsYdkPrcFlytRpr : Base.SasonReporter
    {
        public SrvsYdkPrcFlytRpr()
        {
            Text = "Yedek Parça Faliyet Raporu";
            SubjectCode = "SrvsYdkPrcFlytRpr";
        ...
        public SrvsYdkPrcFlytRpr(decimal servisId, DateTime startDate, DateTime finishDate) : this()
        {
