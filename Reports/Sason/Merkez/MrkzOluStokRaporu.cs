...
namespace SasonBase.Reports.Sason.Merkez
{
    ...
    /// Merkez Stok Raporu
    /// </summary>
    public class MrkzOluStokRaporu : Base.SasonMerkezReporter
    {
        public MrkzOluStokRaporu()
        {
            Text = "[YP-5] Ölü Stok Raporu";
            SubjectCode = "MrkzOluStokRaporu";
        ...
        public MrkzOluStokRaporu(decimal servisId, DateTime startDate, DateTime finishDate) : this()
        {
