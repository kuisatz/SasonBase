...
namespace SasonBase.Reports.Sason.Merkez
{
    ...
    /// </summary>
    public class MrkzTop10ArizaRaporuGarantiHarici : Base.SasonMerkezReporter
    {
        public MrkzTop10ArizaRaporuGarantiHarici()
        {
            Text = "[Grn-5] Top 10 Arıza Listesi Raporu (Garanti Harici)";
            SubjectCode = "MrkzTop10ArizaRaporuGarantiHarici";
        ...
        public MrkzTop10ArizaRaporuGarantiHarici(decimal servisId, DateTime startDate, DateTime finishDate) : this()
        {
