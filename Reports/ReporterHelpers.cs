...
namespace SasonBase.Reports
{
    internal static class ReporterHelpers
    {
        ...
        public static ReporterParameter CreateAgregaSelect(this ReporterParameter param, bool multipleSelect)
        {
            string selectType = (multipleSelect ? "multiple" : "single");
            ...
            <script>$(function() {
                ...
                action('Sason', 'GetAgregaListesi', null, function (res) {
                    if (res.Ok) {
                       getGrid('parameter_name').option('dataSource', res.Data);
                    }
                }
        ...
        public static ReporterParameter CreateAracTipSelect(this ReporterParameter param, bool multipleSelect)
        {
            string selectType = (multipleSelect ? "multiple" : "single");
            ...
            <script>$(function() {
                ...
                action('Sason', 'GetAracTipListesi', null, function (res) {
                    if (res.Ok) {
                       getGrid('parameter_name').option('dataSource', res.Data);
                    }
                }
        ...
        public static ReporterParameter CreateAracTurSelect(this ReporterParameter param, bool multipleSelect)
        {
            string selectType = (multipleSelect ? "multiple" : "single");
            ...
            <script>$(function() {
                ...
                action('Sason', 'GetAracTurListesi', null, function (res) {
                    if (res.Ok) {
                       getGrid('parameter_name').option('dataSource', res.Data);
                    }
                }
        ...
        public static ReporterParameter CreateAksiyonTuruSelect(this ReporterParameter param, bool multipleSelect)
        {
            string selectType = (multipleSelect ? "multiple" : "single");
            ...
            <script>$(function() {
                ...
                action('Sason', 'GetAksiyonTurleriListesi', null, function (res) {
                    if (res.Ok) {
                       getGrid('parameter_name').option('dataSource', res.Data);
                    }
                }
        ...
        public static ReporterParameter CreateTarihGrupSelect(this ReporterParameter param, bool multipleSelect)
        {
            ...
            <script>$(function() {
                ...
                action('Sason', 'GetTarihGrupiListesi', null, function (res) {
                    if (res.Ok) {
                       getGrid('parameter_name').option('dataSource', res.Data);
                    }
                }
