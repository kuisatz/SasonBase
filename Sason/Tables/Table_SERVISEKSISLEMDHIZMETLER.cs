...
{
    [Guid("a52900af-9d18-4928-9f70-6ae8a18b43fa")]
    [DbTableInfoAttribute(TableTypes.Table, "SERVISEKSISLEMDHIZMETLER", "Sason.Tables", "Yok")]
    [DbField(1, "ID", typeof(Decimal), null, DbFieldFlags.None, 22, 0, 0, "")]
    [DbField(2, "SERVISEKSPERTIZISLEMID", typeof(Decimal), null, DbFieldFlags.None, 22, 0, 0, "")]
    [DbField(3, "ACIKLAMA", typeof(String), null, DbFieldFlags.None, 70, 0, 0, "")]
    ...
    [DbIndex("SEVISEKSPISLEMDHIZMETLER_PK", DbIndexType.PrimaryKey, DbIndexFlags.Clustered | DbIndexFlags.Unique, new string[] {"ID"})]
    public abstract class Table_SERVISEKSISLEMDHIZMETLER : SasonDbTable
    {
        [Serializable()]
        [DbTableType(typeof(Table_SERVISEKSISLEMDHIZMETLER))]
