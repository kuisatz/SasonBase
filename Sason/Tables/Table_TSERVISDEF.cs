...
{
    [Guid("B2BEF7FE-3606-4882-8745-5C390FBB4B0C")]
    [DbTableInfo(Antibiotic.Database.Connectors.TableTypes.Table, "TSERVISDEF", "Sason.Tables", "Servisler İçin Tanımlar Tablosu")]
    ...
    [DbIndex("PK_TSERVISDEF", DbIndexType.PrimaryKey, DbIndexFlags.Clustered | DbIndexFlags.Unique, new string[] { "ID" })]
    [DbIndex("IX_TSERVISDEF", DbIndexType.Index, DbIndexFlags.Unique, new string[] { "FTABLE", "FKEY1", "FKEY2", "FKEY3", "FKEY4", "FKEY5", "FCODE" })]
    public abstract class Table_TSERVISDEF : DbTable
    {
        [Serializable()]
        [DbTableType(typeof(Table_TSERVISDEF))]
