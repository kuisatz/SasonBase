...
{
    [Guid("0f44898c-a6c7-48ef-b82d-289d6a9cba6d")]
    [DbTableInfoAttribute(TableTypes.Table, "ISORTAKLAR", "Sason.Tables", "Yok")]
    [DbField(1, "ID", typeof(Decimal), null, DbFieldFlags.None, 22, 0, 0, "")]
    [DbField(2, "AD", typeof(String), null, DbFieldFlags.None, 200, 0, 0, "")]
    [DbField(3, "VARLIKID", typeof(Decimal), null, DbFieldFlags.None, 22, 0, 0, "")]
    ...
    [DbField(32, "DURUMID", typeof(Decimal), null, DbFieldFlags.None, 22, 0, 0, "")]
    [DbField(33, "STOKTURID", typeof(Decimal), null, DbFieldFlags.Nullable, 22, 0, 0, "")]
    [DbIndex("ISORTAKLAR_PK", DbIndexType.PrimaryKey, DbIndexFlags.Clustered | DbIndexFlags.Unique, new string[] {"ID"})]
    [DbIndex("IOTYPU", DbIndexType.Index, DbIndexFlags.None, new string[] {"IOTYPU"})]
    [DbIndex("ISORTAKLAR_U01", DbIndexType.Index, DbIndexFlags.Unique, new string[] {"AD","VARLIKID"})]
    public abstract class Table_ISORTAKLAR : SasonDbTable
    {
        [Serializable()]
        [DbTableType(typeof(Table_ISORTAKLAR))]
        ...
        public abstract class ProtectedItem : RawItem
        {
            ...
            protected virtual Decimal STOKTURID { get; set; }
        }
        [Serializable()]
        public abstract class PublicItem : RawItem
        {
            ...
            public virtual Decimal? STOKTURID { get; set; }
        }
    }
}
